...
>>>>>>> b42e5b08aaa38bea2e0c8dd5115fa60b499bab8e
				</div>
				<div class="col-md-4"></div>
			</div>
			<div class="row">
				<div class="col-md-4"></div>
				<div class="col-md-4">
					<a href="unDirectPay.php" style="display:none;"><button type="button" class="btn btn-default" id="undirectpayMenu">Undirect Pay</button></a>
				</div>
				<div class="col-md-4"></div>
			</div>
			<div class="row">
